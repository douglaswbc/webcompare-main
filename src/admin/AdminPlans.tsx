    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
           <div className="bg-[#0d141c] p-1 rounded-lg border border-slate-700 flex flex-1 md:flex-none">
              <button onClick={() => setView('plans')} className={`flex-1 md:flex-none px-4 py-2 rounded ${view === 'plans' ? 'bg-[#0096C7] text-white' : 'text-slate-400 hover:text-white'}`}>Planos</button>
              <button onClick={() => setView('providers')} className={`flex-1 md:flex-none px-4 py-2 rounded ${view === 'providers' ? 'bg-[#0096C7] text-white' : 'text-slate-400 hover:text-white'}`}>Provedores</button>
           </div>
